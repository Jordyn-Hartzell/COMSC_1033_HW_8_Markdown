...
```
# Summary
The projects for this week were both programs involving randomly generated characters. For the first program, I used a for loop, variables, scanner, math.random method, and if/else statements to create an addition game with increasing and decreasing difficulty. The second program was a simple number generator that used the generated number to display a corresponding capitol letter. We have also began to use markdown as the format for our reports. We learned the basics of markdown and the use of different characters within markdown. I found markdown to be an easy transition because it's the format we are used to seeing while using Github. I think that it is useful to know how to use this format because you can use it to create a report within the readme file attached to your Github project. Having a report or overview of your code attached to the actual project is very useful and efficient. It allows anybody that clones your repository to have immediate access to the corresponding report and I think that's very professional. 